...
class PrivacyPolicy_Page extends StatelessWidget {
  ...
  // ⚠️ عدّل هذه القيم حسب بياناتك الفعلية
  ...
  static const String ownerPhoneNumber = "0658403317"; // ⚠️ أدخل رقم هاتفك هنا
  ...
  static const String disclaimerText =
      "تم تصميم هذا التطبيق لتقديم خدمات طلب وتوصيل الطعام. الصلاحيات المطلوبة تُستخدم حصرياً لتحسين تجربة المستخدم وإتمام الطلبات. لا يتحمل المطور أو '$companyName' أي مسؤولية قانونية عن أي أضرار مباشرة أو غير مباشرة قد تنتج عن استخدام التطبيق، أو عن سوء استخدام الجهاز. استخدامك للتطبيق يُعد موافقة صريحة على هذه الشروط وإخلاءً تاماً لمسؤوليتنا.";
  ...
  static const String policyText =
      ...
      "في حال حدوث أي مشكلة أو كان لديك أي استفسار، الطريقة الرسمية والوحيدة المعتمدة للتواصل هي الاتصال المباشر بمالك التطبيق عبر رقم الهاتف: $ownerPhoneNumber.";
